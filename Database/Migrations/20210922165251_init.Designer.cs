...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Database.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Database.Models.OrderOrderState", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("OrderOrderStates");
                });

            modelBuilder.Entity("Database.Models.OrderState", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Database.Models.OrderOrderState", b =>
                {
                    b.HasOne("Database.Models.Order", "Order")
                        .WithMany("OrderOrderStates")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Database.Models.OrderState", "OrderState")
                        .WithMany()
