    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderOrderStates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderOrderStates_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderOrderStates_OrderStates_OrderStateId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderOrderStates_OrderId",
                table: "OrderOrderStates",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderOrderStates_OrderStateId",
                table: "OrderOrderStates",
                column: "OrderStateId");
